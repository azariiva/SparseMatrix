...
template <class T_KEY, class T_ITEM>
static Node<T_KEY,T_ITEM> *recursive_copy(const Node<T_KEY,T_ITEM> *src, Node<T_KEY,T_ITEM> *p=Node<T_KEY,T_ITEM>::nil_node) {
    Node<T_KEY,T_ITEM> *node;
...
template <class T_KEY, class T_ITEM>
static Node<T_KEY,T_ITEM> *iterative_copy(const Node<T_KEY,T_ITEM> *src) {
    Node<T_KEY,T_ITEM> *root = new Node<T_KEY,T_ITEM>(*src, Node<T_KEY,T_ITEM>::nil_node);
    Node<T_KEY,T_ITEM> *dst = root;
